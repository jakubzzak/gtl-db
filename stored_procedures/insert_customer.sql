create procedure insertCustomer @ssn varchar(20), @email varchar(100), @password varchar(60), @first_name varchar(100),
                                ...
                                @country varchar(100), @phone_country_code as varchar(5), @phone_number varchar(15), @phone_type varchar(30) as
begin try
    ...
    insert into customer values (@ssn, @email, @password, @first_name, @last_name, @campus_id, @user_type, @address_id, @can_reserve,
            @can_borrow, @books_borrowed, @books_reserved, @is_active);

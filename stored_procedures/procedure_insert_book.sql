create or alter procedure insertBook @isbn varchar(30), @title varchar(150), @author varchar(100), @subject_area varchar(100),
...
begin try
    begin transaction insert into book
                      values (@isbn, @title, @author, @subject_area, @description, @is_loanable, @total_copies,
                              @total_copies, @resource_type, 0); commit transaction;
end try begin catch
